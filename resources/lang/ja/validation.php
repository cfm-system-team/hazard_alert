...
return [
    ...
    */
    ...
    'custom' => [
        'recipient.email' => [
            'confirmed' => ':attributeとメールアドレスの確認が一致していません。',
        ],
        'recipient.check_terms' => [
            'required' => '利用規約に同意されていません',
            'regex' => '利用規約に同意されていません'
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'search.start_at' => '登録日時の範囲（開始）',
        'search.end_at' => '登録日時の範囲（終了）',
    ],
